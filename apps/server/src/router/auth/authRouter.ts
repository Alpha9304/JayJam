  ...
  register: publicProcedure
    ...
    .mutation(async ({ ctx, input }) => { // mutation for POST/PUT/DELETE
      try {
        ...
        return {
          success: false,
          message: `Couldn't register ${input.email}, ${error}`}
      }
  ...
  login: publicProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      try {
        ...
        return {
          success: false,
          message: `Couldn't log in ${input.email}, ${error}`}
      }
    }),
  ...
  sendVerificationCode: publicProcedure
      ...
      .mutation(async ({ctx, input}) => { 
        ...
        await resend.emails.send({
            ...
            to: email, 
            subject: 'Welcome to Team03 Study App', 
    ...
    sendResetCode: publicProcedure
      ...
      .mutation(async ({input}) => { 
        ...
        await resend.emails.send({
            from: 'verification@derailedblog.com', 
            to: email, 
            subject: 'Team03 Study App: Reset your password with this code:', 
