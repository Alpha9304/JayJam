...
export const testToolsRouter = router({
    ...
    deleteVerification: publicProcedure
    .meta({ openapi: { method: 'POST', path: '/delete-verification' } }) //expose the procedure as a REST endpoint, so access at localhost:3001/create-user
