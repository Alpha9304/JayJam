  ...
  return (
    <div>
      ...
      >
        ...
        <div className="mt-60 bg-white bg-opacity-80 backdrop-blur-lg p-8 rounded-xl shadow-2xl border border-gray-300 w-full max-w-md">
        ...
        <div className="absolute bottom-1 right-1 text-right text-gray-200 mt-2 tracking-wide bg-gradient-to-r from-cyan-300 to-blue-400 text-transparent bg-clip-text">
