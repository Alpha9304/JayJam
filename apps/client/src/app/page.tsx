...
export default function HomePage() {
  ...
  return (
    <div>
      <Head>
        <title>Sign In | Team03 ClassGroups</title>
      ...
      <div
        ...
        style={{
          background: "linear-gradient(45deg, #99ffff,rgb(136, 194, 252), #9999ff, #9966ff,rgba(209, 92, 150, 0.9),rgb(130, 209, 255))",
      ...
      >
        ...
        <div className="absolute top-32 text-center">
          ...
          <p className="text-lg md:text-xl font-medium text-gray-200 mt-2 tracking-wide bg-gradient-to-r from-cyan-300 to-blue-400 text-transparent bg-clip-text">
            Join your class groups and enjoy automatic scheduling!
          </p>
        </div>

        {/* Login Box (Static Size) */}
        <div className="mt-48 bg-white bg-opacity-80 backdrop-blur-lg p-8 rounded-xl shadow-2xl border border-gray-300 w-full max-w-md">
