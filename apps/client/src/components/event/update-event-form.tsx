    ...
    return (
        <div className="space-y-6 px-6 pb-4">
            <DialogHeader className="space-y-2 mt-4">
                <DialogTitle className="text-2xl font-bold" data-testid="update-event-title">Update Study Event</DialogTitle>
            ...
            <Card className="p-4">
                <div className="space-y-4">
                    <div>
                        <h3 className="text-lg font-semibold" data-testid="event-id">Event ID: {eventId}</h3>
                          ...
                          <div className="space-y-2 mt-4">
                            ...
                            {locationOptions.map((option) => (
                              <div
                                ...
                                data-testid={`location-option-${option.id}`}
                              >
                      ...
                      />
                        <div className="flex justify-between gap-x-4 mt-8">
                            ...
                            <Button
                              ...
                              data-testid="finalize-event-btn"
                            >
